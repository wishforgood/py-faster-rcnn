...
import _init_paths
from fast_rcnn.test import get_net_outputs
...
def parse_args():
    ...
    parser.add_argument('--img_prefix', dest='img_prefix',
                        help='image prefix',
                        default='/home/zsy/dataset/The_Visual_Genome_Dataset/VG_100K', type=str)
